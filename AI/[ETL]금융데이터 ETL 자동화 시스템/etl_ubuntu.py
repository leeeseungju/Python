...
Original file is located at
    https://colab.research.google.com/drive/1DbHJOHNirYmLRUqmU8-q_-sU7PAXSIuH
...
accountDataUrl = "/home/kopo/pywork/dataset/account_info.csv"
...
# CSV 파일을 읽어 Data Frame 변수에 저장하기
customerDataUrl = "/home/kopo/pywork/dataset/customer_info.csv"
encoding = ["ms949","utf-8"]
for i in range(0, len(encoding)):
    try:
...
inData.to_csv("/home/kopo/pywork/dataset/join_financial_data.csv", index=False)

inData.to_sql("join_financial_data", con=myngine, if_exists="replace", index=False)
print("join_financial_data 복사 완료")

merged_df.to_csv("/home/kopo/pywork/dataset/backup_join_financial_data.csv", index=False)
print("CSV 백업 저장 완료: backup_join_financial_data.csv")